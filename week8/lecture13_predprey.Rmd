...
# note the use of with
# initial conditions
currpop_pred = c(prey=10, pred=4)

# time points to see results
days = seq(from=1, to=100, by=1)

# set parameters
pars_pred = c(rprey=0.5, alpha=0.7, eff=0.3, pmort=0.2, K=100)

# run the model
res = ode(func=lotvmod, y=currpop_pred, times=days, parms=pars_pred)
