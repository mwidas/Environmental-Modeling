...
#what is this?
# this is the derivative at p=20 for a r of 0.01
...
# this is a straight line because the derivative is changing consistently
...
```{r iterate1}
source("week5/R/discrete_logistic_popK.R")
...
# ODE example
## using differential equation solver for ordinary differential equation
```{r usingode}
source("week5/R/dexppop.R")

#ode solver requires time as an input but does not use it
dexppop
...
# run the solver
# parms=c(0.01) is the growth rate which is the parameter
# this equation is solving for P aka population
